...
export const getAllImages = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const res = await axios.get("https://gallery-app-1-r18o.onrender.com/api/v1/get/images");
            return res.data;
        } catch (error) {
...
export const getAllCategories = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const res = await axios.get("https://gallery-app-1-r18o.onrender.com/api/v1/get/categories");
            return res.data;
        } catch (error) {
            return rejectWithValue(error.response?.data || error.message);
        }
    ...
    async (payload, { rejectWithValue }) => {
        try {
            const res = await axios.post(
                "https://gallery-app-1-r18o.onrender.com/api/v1/add/category",
                payload
            );
            return res.data;
        } catch (error) {
...
export const postNewImage = createAsyncThunk(
    ...
    async (payload, { rejectWithValue }) => {
        try {
            const res = await axios.post(
                "https://gallery-app-1-r18o.onrender.com/api/v1/upload/image",
                payload
            );
            return res.data;
        } catch (error) {
    ...
    async (payload, { rejectWithValue }) => {
        try {
            const res = await axios.get(
                `https://gallery-app-1-r18o.onrender.com/api/v1/get/singleimage?category=${payload}`
            );
            return res.data;
        } catch (error) {
            return rejectWithValue(error.response?.data || error.message);
